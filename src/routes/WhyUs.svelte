        ...
        <div class="col-md-4">
          <div class="box b3">
            <div class="detail-box">
              ...
              <p>
                Our team consist of experienced developers with 4-13 years of experience in software development and Information Technology, most projects we've done are in e-commerce, insurance, education, multimedia, and infrastructure sector. We use the most make-sense practice, in terms of maintainability and performance (because best-practice for one company doesn't always best for other company).
              </p>
            </div>
          </div>
        </div>
